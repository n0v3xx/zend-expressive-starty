...
COMMAND_DOCKER_PS="docker ps --all --filter \"name=${DOCKER_ALIAS}\" --format \"{{.ID}}\t{{.Names}}\""
COMMAND_DOCKER_IMAGES="docker images --filter=reference='*${DOCKER_ALIAS}*' --format \"{{.ID}}\t{{.Repository}}\""
